...
public class CalendarProgram{
    ...
    public CalendarProgram (){
        ...
        //Prepare frame
        frmMain = new JFrame ("Planting Calander"); //Create frame
        ...
        tblCalendar.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
               if(pressingCTRL){//check if user is pressing CTRL key
                    int row = tblCalendar.rowAtPoint(e.getPoint());//get mouse-selected row
                    int col = tblCalendar.columnAtPoint(e.getPoint());//get mouse-selected col
                    //int daate = tblCalendar.
                    
                    selectedDay = (int)tblCalendar.getValueAt(row, col);
                    selectedMonth = currentMonth;
                   selectedYear = currentYear;
            
                    //System.out.println("Date Selected = " + selectedMonth+"/" + selectedDay + "/" + selectedYear);
    ...
    public static int [] getSelectedDate () 
    {        
        int [] arr = new int [3];
        arr[0]= selectedDay;
        arr[1] = selectedMonth;
