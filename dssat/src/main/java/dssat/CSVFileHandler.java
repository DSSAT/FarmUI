...
public class CSVFileHandler {
    ...
    public HashMap<String, HashMap<String, HashMap<String, String>>> ReadSitesFile() {
        ...
        try {
            ...
            reader = new CSVReader(new InputStreamReader(getClass().getResourceAsStream("/properties/sites/sitesinfo.sites")));
    ...
    public ArrayList getCountyList_SoilDB() {
        ...
        try {
            ...
            reader = new CSVReader(new InputStreamReader(getClass().getResourceAsStream("/properties/csv/dssat_countywise_list_of_soils.csv")));
            //reader = new CSVReader(new FileReader(filepath));
    ...
    public ArrayList getCountyList_GlobalDB() {
        ...
        try {
            ...
            //reader = new CSVReader(new InputStreamReader(getClass().getResourceAsStream("/properties/csv/counties_centroid.csv")));
            reader = new CSVReader(new InputStreamReader(getClass().getResourceAsStream("/properties/csv/counties_centroid.csv")));
            while ((nextLine = reader.readNext()) != null) {
    ...
    public String getWeatherStationId_GlobalDB(String weatherstationname) {
        ...
        try {
            ...
            //reader = new CSVReader(new FileReader(filepath));
            reader = new CSVReader(new InputStreamReader(getClass().getResourceAsStream("/properties/csv/fawn_lookup.csv")));
            while ((nextLine = reader.readNext()) != null) {
                location = nextLine[2];
    ...
    public String getCropID(String cropName) {
        try {
            CSVReader reader = new CSVReader(new InputStreamReader(getClass().getResourceAsStream("/properties/csv/dssat_crop_lookup.csv")));
            String[] row;
    ...
    public String getCulId(String filePath,String cultiVar){
        
        try{
            InputStreamReader isr = new InputStreamReader(getClass().getResourceAsStream("/properties/Genotype/" + filePath ));
